    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.commands = {
            ...
            " Get Github Repository Projects ": self.get_repo_projects,
            " Get Github Repository Project Columns ": self.get_repo_project_columns,
            " Get Github Repository Project Column Cards ": self.get_repo_project_column_cards,
            " Create Github Repository Project Column Card ": self.create_repo_project_column_card,
            " Update Github Repository Project Column Card ": self.update_repo_project_column_card,
            " Get Github Repository Projects ": self.get_repo_projects,
            " Get Github Repository Project Columns ": self.get_repo_project_columns,
            " Get Github Repository Project Column Cards ": self.get_repo_project_column_cards,
            " Create Github Repository Project Column Card ": self.create_repo_project_column_card,
